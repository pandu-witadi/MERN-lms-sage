...
import {http_profile_delete} from "../../../../services/operations/SettingsAPI.js"
...
export default function DeleteAccount() {
    ...
    return (
        <>
            <div className="card bordered p-4 flex flex-row gap-x-5 rounded-md border-[1px] border-pink-700 bg-pink-900">
                <div className="flex aspect-square h-14 w-14 items-center justify-center rounded-full bg-pink-700">
                    <FiTrash2 className="text-3xl text-pink-200"/>
                </div>

                <div className="flex flex-col ">
                    <h2 className="text-lg font-semibold text-base-300"> Delete Account</h2>
                        ...
                        <button
                            ...
                            onClick={() => check &&
                                setConfirmationModal({
                                    ...
                                    btn1Text: "Delete",
                                    btn2Text: "Cancel",
                                    btn1Handler: () => dispatch(http_profile_delete(token, navigate)),
                                    btn2Handler: () => {
