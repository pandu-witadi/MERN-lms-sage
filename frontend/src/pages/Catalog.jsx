    ...
    return (
        <>
            ...
            <div className=" box-content bg-richblack-800 px-4">
                <div className="mx-auto flex min-h-[40px] max-w-maxContentTab flex-col justify-center gap-4 lg:max-w-maxContent ">
            ...
            <div className=" mx-auto box-content w-full max-w-maxContentTab px-4 py-12 lg:max-w-maxContent">
                <div className="section_heading">
                    <HighlightText text={catalogPageData?.selectedCategory?.name}/> Courses to get you started
                </div>
            ...
            {/* Section 3 */}
            <div className=" mx-auto box-content w-full max-w-maxContentTab px-4 py-12 lg:max-w-maxContent">
                <div className="section_heading">Favorite Courses</div>
                <div className="py-8">
